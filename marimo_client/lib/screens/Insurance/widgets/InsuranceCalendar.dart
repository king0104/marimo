...
Future<void> showCustomCalendarPopup({
  ...
  DateTime? minDate,  // 최소 선택 가능 날짜 추가
}) async {
            ...
            child: Row(
              children:
                  week.asMap().entries.map((entry) {
                    ...
                    final isSelectedDay = selectedDate != null &&
                    ...
                    return Expanded(
                      child: GestureDetector(
                        onTap: isDisabled ? null : () => onSelectDate(date),
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 14.sp,
                                    fontWeight: isSelectedSunday || isSelectedDay
                                        ? FontWeight.w600
                                        : FontWeight.w400,
                                    color: isDisabled
                                        ? Colors.grey[300]
                                        : (isSunday ? Colors.red[300] : Colors.black),
                                  ),
                                ),
                              ),
                            ),
