...
-   주유소 필터 적용 후 추천 리스트 응답 로직 완성
-   보험 쪽 와이어프레임 수정
-   주유소 FE provider 및 API 연동 중
...
-   보험 등록 후 뒤로가기 오류 해결
-   네비게이션 프로바이더 추가
-   날씨 API 연동해서 실제 날씨 및 기온 출력, 날씨별 운전 문구 출력
...
-   Chatbot UI 수정
-   고장 정보 분석 AI 구현
-   대화형 AI 에이전트 모델 파인튜닝 (최소 10시간 소요 예상)

### 조현희

-   차계부 입력 상세 폼에서 금액 수정 가능하게 만듦 + 금액 동기화
-   타이어 AI 모델 테스트 ing

### 이가영

-   주유소 API 테스트 중 좌표 설정 디버깅
-   의존성 proj4j 설치
...
10:00 ~ 13:00 - OBD2 상태 정리 및 라이팅 확정
13: 00 ~ 14:00 - 상태 정보 카드 UX 관련 논의
14:00 ~ 15:00 - QA UI 치기
15:00 ~ 16:00 - 차량 상태 정보 관련 UI 치기
16:00 ~ 18:00 - AI 관련 논의

### 윤수빈

-   애증의 카드… 조회 API 90퍼 완료
-   카드 관련 유저 정보 등록 및 DB에 등록

### 김두철

-   이메일 인증 구현
-   Security, JWT Filter 수정
-   Flutter 회원가입/로그인 로직 구현
